<template>
  <v-card flat>
    ...
    <v-divider></v-divider>
    <v-data-table-server v-model:items-per-page="itemsPerPage" :headers="props.headers" :items="data" item-value="Id"
    
       :show-expand="props.showExpand" :sort-by="props.sortBy"
